    ...
    <div className="w-full flex flex-col items-center py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 sm:px-25 px-5 mt-4">
        ...
        <div className="bg-white/40 backdrop-blur-md rounded-2xl shadow-md p-6 flex flex-col items-center text-center hover:scale-105 transition-transform">
          ...
          <h2 className="text-lg font-semibold mb-2">Comparer les équipes</h2>
        ...
        <div className="bg-white/40 backdrop-blur-md rounded-2xl shadow-md p-6 flex flex-col items-center text-center hover:scale-105 transition-transform">
          ...
          <h2 className="text-lg font-semibold mb-2">Voir les meilleures actions</h2>
          <p className="text-gray-700 text-[12px] mt-5">
        ...
        <div className="bg-white/40 backdrop-blur-md rounded-2xl shadow-md p-6 flex flex-col items-center text-center hover:scale-105 transition-transform">
          ...
          <h2 className="text-lg font-semibold mb-2">Planifier ta saison</h2>
          <p className="text-gray-700 text-[12px] mt-5">
        ...
        <div className="bg-white/40 backdrop-blur-md rounded-2xl shadow-md p-6 flex flex-col items-center text-center hover:scale-105 transition-transform">
          ...
          <h2 className="text-lg font-semibold mb-2">Analyser le classement</h2>
          <p className="text-gray-700 text-[12px] mt-5">
